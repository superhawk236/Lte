...
UeLtePhy::UeLtePhy()
{
  ...
  //std::cout<<"Interference"<<std::endl;//memorytest
...
UeLtePhy::DoSetBandwidthManager (void)
{
  ...
  //std::cout<<"TransmittedSignal"<<std::endl;//memorytest
...
#ifdef TEST_DEVICE_ON_CHANNEL
  std::cout << "UE Node " << GetDevice()->GetIDNetworkNode () << " starts phy rx" << std::endl;
#endif
  /*//no need DL
